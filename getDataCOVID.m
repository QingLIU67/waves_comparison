...
%address = 'https://github.com/CSSEGISandData/COVID-19/tree/master/csse_covid_19_data/';
ext = '.csv';
...
%         tableConfirmed =readtable('dummy.csv', opts);
        tableConfirmed =readtable('time_series_covid19_confirmed_global.csv', opts);
        
    elseif strcmpi(status{ii},'Deaths')
%         tableDeaths =readtable('dummy.csv', opts);
        tableDeaths =readtable('time_series_covid19_deaths_global.csv', opts);
        
    elseif strcmpi(status{ii},'Recovered')
%         tableRecovered =readtable('dummy.csv', opts);
        tableRecovered =readtable('time_series_covid19_recovered_global.csv', opts);
    else
