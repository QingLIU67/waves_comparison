function [alpha1,beta1,gamma1,delta1,Lambda1,Kappa1,lambdaFun,kappaFun,tau1,time_delay1,NPI_matrix] = fit_SEIQRDP_1(Q,R,D,Npop,E0,I0,C0,time,guess,NPIs,varargin)
...
options=optimset('TolX',tolX,'TolFun',tolFun,...
    'MaxFunEvals',2000,'Display',Display);  %1200,5000
